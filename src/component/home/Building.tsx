  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center md:py-6 md:px-14 py-2 px-4">
        <h1 className="md:text-2xl md:font-extrabold text-xl font-bold font-kantum text-black">
          Building Trusted Partnerships
        </h1>
        <p className="items-center text-center text-black">
          Now an established partner in the healthcare ecosystem, Wasatch Health
          continues to invest $5–25M in growth-ready <br className="" />{" "}
          businesses, focusing on long-term value creation through equity, debt,
      ...
      <div className="relative w-full h-[300px] flex items-center justify-center overflow-hidden">
        ...
        {/* SVG - Lines + End Logos + Avatars + MOVING DOTS */}
        <svg
        ...
        >
          ...
          {/* Left Top Curve Dot */}
          <circle r="3.5" fill="#1B3650">
            <animateMotion
              path="M600 150 C 490 150, 440 82, 340 82 S 200 82, 125 82"
              dur="6.5s"
              repeatCount="indefinite"
            />
          </circle>

          {/* Left Bottom Curve Dot */}
          <circle r="3.5" fill="#1B3650">
            <animateMotion
              path="M600 150 C 490 150, 440 218, 340 218 S 200 218, 125 218"
              dur="6.5s"
              repeatCount="indefinite"
              begin="0.4s"
            />
          ...
          <circle r="3.5" fill="#1B3650">
            <animateMotion
              path="M600 150 C 710 150, 760 82, 860 82 S 1000 82, 1075 82"
              dur="6.5s"
              repeatCount="indefinite"
              begin="0.8s"
            />
          ...
          {/* Right Bottom Curve Dot */}
          <circle r="3.5" fill="#1B3650">
            <animateMotion
              path="M600 150 C 710 150, 760 218, 860 218 S 1000 218, 1075 218"
              dur="6.5s"
              repeatCount="indefinite"
              begin="1.2s"
            />
          ...
          {/* Center Horizontal Line Dot */}
          <circle r="3.5" fill="#1B3650">
            <animateMotion
              path="M125 150 L 1075 150"
              dur="6.5s"
              repeatCount="indefinite"
              begin="1.5s"
            />
          ...
          {/* Avatars */}
          <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 1.7, duration: 0.5 }}>
          ...
          <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 2.0, duration: 0.5 }}>
            <foreignObject x="1065" y="55" width="70" height="70">
              <Avatar src="/Ellipse121.png" />
            </foreignObject>
          </motion.g>

          <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 2.1, duration: 0.5 }}>
